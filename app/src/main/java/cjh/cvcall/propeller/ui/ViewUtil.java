package cjh.cvcall.propeller.ui;
...
public class ViewUtil {
    ...
    /* package */
    static public final boolean checkDoubleTouchEvent(MotionEvent event, View view) {
        if (DEBUG_ENABLED) {
    ...
    /* package */
    static public final boolean checkDoubleKeyEvent(KeyEvent event, View view) {
        if (DEBUG_ENABLED) {
